...
local chain = (function(movements)
  ...
  return function()
    ...
    if lastSeenChain ~= movements or lastSeenAt < now - chainResetInterval or
        lastSeenWindow ~= id then
      sequenceNumber = 1
