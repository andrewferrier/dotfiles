...
# --gutter not supported on fzf version on Debian
# export FZF_DEFAULT_OPTS_INITIAL='--gutter=" "'
export FZF_DEFAULT_OPTS_INITIAL='--exact --info=inline-right --no-separator'
